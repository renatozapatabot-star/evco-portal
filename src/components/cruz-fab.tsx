...
export function CruzFAB() {
  ...
  const actions = [
    ...
    {
      icon: MessageSquare, label: 'AGUILA AI',
      color: 'var(--gold)',
    ...
    <>
      ...
      >
        {open ? (
          ...
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: 13, fontWeight: 800, color: 'var(--text-primary)', letterSpacing: '0.08em' }}>AGUILA</span>
        )}
      </button>
