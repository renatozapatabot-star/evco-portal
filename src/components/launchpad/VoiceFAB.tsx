  ...
  return (
    <>
      ...
      {!isActive && (
        ...
        >
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--portal-fg-1)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
