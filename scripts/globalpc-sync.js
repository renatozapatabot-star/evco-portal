...
async function run() {
  ...
  await syncTable({
    name: 'traficos', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_trafico WHERE sCveTrafico LIKE '${CLIENT_CLAVE}-%'`,
    ...
    FROM cb_trafico WHERE sCveTrafico LIKE '${CLIENT_CLAVE}-%' ORDER BY dFechaIngreso ASC`,
    table: 'traficos',
    conflictCol: 'trafico',
    mapRow: r => ({
      trafico: r.trafico, company_id: COMPANY_ID, tenant_id: TENANT_ID, tenant_slug: COMPANY_ID,
  ...
  await syncTable({
    name: 'entradas', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_entrada_bodega WHERE sCveCliente = '${CLIENT_CLAVE}'`,
    ...
    FROM cb_entrada_bodega WHERE sCveCliente = '${CLIENT_CLAVE}' ORDER BY dFechaIngreso ASC`,
    table: 'entradas',
    conflictCol: 'cve_entrada',
    mapRow: r => ({
      cve_entrada: r.cve_entrada, cve_embarque: r.embarque, cve_cliente: r.cve_cliente,
      cve_proveedor: r.proveedor, company_id: COMPANY_ID, tenant_id: TENANT_ID, tenant_slug: COMPANY_ID,
  ...
  const ok3 = await syncTable({
    name: 'globalpc_facturas', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_factura WHERE sCveCliente = '${CLIENT_CLAVE}'`,
    ...
    FROM cb_factura WHERE sCveCliente = '${CLIENT_CLAVE}' ORDER BY iFolio ASC`,
    ...
    mapRow: r => ({
      ...
      tenant_id: TENANT_ID, updated_at: new Date().toISOString(),
    }),
  })
  if (ok3 === false) {
  ...
  await syncTable({
    name: 'globalpc_partidas', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_producto_factura WHERE sCveCliente = '${CLIENT_CLAVE}'`,
    ...
    FROM cb_producto_factura WHERE sCveCliente = '${CLIENT_CLAVE}' ORDER BY iFolio ASC`,
  ...
  await syncTable({
    name: 'globalpc_eventos', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_eventos_trafico WHERE sCveTrafico LIKE '${CLIENT_CLAVE}-%'`,
    ...
    FROM cb_eventos_trafico WHERE sCveTrafico LIKE '${CLIENT_CLAVE}-%' ORDER BY iConsecutivo ASC`,
    ...
    mapRow: r => ({
      ...
      remesa: r.remesa, tenant_id: TENANT_ID,
    }),
  })

  // 6. cb_contenedores_trafico → globalpc_contenedores
  await syncTable({
    name: 'globalpc_contenedores', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_contenedores_trafico WHERE sCveTrafico LIKE '${CLIENT_CLAVE}-%'`,
    query: `SELECT iConsecutivo AS consecutivo, sCveTrafico AS cve_trafico,
    ...
    FROM cb_contenedores_trafico WHERE sCveTrafico LIKE '${CLIENT_CLAVE}-%' ORDER BY iConsecutivo ASC`,
    ...
    mapRow: r => ({
      ...
      pais_transporte: r.pais_transporte, tenant_id: TENANT_ID,
    }),
  })

  // 7. cb_orden_carga (via detalle join for EVCO) → globalpc_ordenes_carga
  await syncTable({
    name: 'globalpc_ordenes_carga', db,
    countQuery: `SELECT COUNT(DISTINCT oc.iConsecutivo) as total FROM cb_orden_carga oc
      ...
      WHERE doc.sCveTrafico LIKE '${CLIENT_CLAVE}-%'`,
    ...
    INNER JOIN cb_detalle_orden_carga doc ON oc.iConsecutivo = doc.iConsecutivoOrdenCarga
    WHERE doc.sCveTrafico LIKE '${CLIENT_CLAVE}-%' ORDER BY oc.iConsecutivo ASC`,
    ...
    mapRow: r => ({
      ...
      num_patente: r.num_patente, tenant_id: TENANT_ID,
    }),
  })

  // 8. cu_cliente_proveedor → globalpc_proveedores
  await syncTable({
    name: 'globalpc_proveedores', db,
    countQuery: `SELECT COUNT(*) as total FROM cu_cliente_proveedor WHERE sCveCliente = '${CLIENT_CLAVE}'`,
    ...
    FROM cu_cliente_proveedor WHERE sCveCliente = '${CLIENT_CLAVE}' ORDER BY sCveProveedor ASC`,
    ...
    mapRow: r => ({
      ...
      telefono: r.telefono, tenant_id: TENANT_ID,
    }),
  })

  // 9. cu_cliente_proveedor_producto → globalpc_productos
  await syncTable({
    name: 'globalpc_productos', db,
    countQuery: `SELECT COUNT(*) as total FROM cu_cliente_proveedor_producto WHERE sCveCliente = '${CLIENT_CLAVE}'`,
    ...
    FROM cu_cliente_proveedor_producto WHERE sCveCliente = '${CLIENT_CLAVE}' ORDER BY sCveClienteProveedorProducto ASC`,
    ...
    mapRow: r => ({
      ...
      precio_unitario: r.precio, tenant_id: TENANT_ID,
    }),
  })

  // 10. cb_bulto → globalpc_bultos
  await syncTable({
    name: 'globalpc_bultos', db,
    countQuery: `SELECT COUNT(*) as total FROM cb_bulto WHERE sCveEntradaBodega IN
      (SELECT sCveEntradaBodega FROM cb_entrada_bodega WHERE sCveCliente = '${CLIENT_CLAVE}')`,
    ...
    mapRow: r => ({
      ...
      descripcion: r.descripcion, tenant_id: TENANT_ID,
    }),
  })
  ...
  await syncTable({
    ...
    mapRow: r => ({
      ...
      observaciones: r.observaciones, tenant_id: TENANT_ID,
    }),
  })
  ...
  await syncTable({
    ...
    mapRow: r => ({
      ...
      referencia: r.referencia, tenant_id: TENANT_ID,
    }),
  })
  ...
  await syncTable({
    ...
    mapRow: r => ({
      ...
      fecha: r.fecha, tenant_id: TENANT_ID,
    }),
  })
  ...
  await syncTable({
    ...
    mapRow: r => ({
      ...
      moneda: r.moneda, concepto: r.concepto, tenant_id: TENANT_ID,
    }),
  })
  ...
  await syncTable({
    ...
    mapRow: r => ({
      ...
      tipo_cambio: r.tipo_cambio, concepto: r.concepto, tenant_id: TENANT_ID,
    }),
  })
  ...
  await syncTable({
    ...
    mapRow: r => ({
      ...
      fecha: r.fecha, importe: r.importe, moneda: r.moneda,
      tipo_cambio: r.tipo_cambio, tenant_id: TENANT_ID,
    }),
  })
  ...
  try {
    ...
    if (!key) {
      ...
      clearCP('wsdl_docs')
      console.log(`\n✅ WSDL: ${totalDocs} docs cataloged · ${filesUploaded} PDFs uploaded from ${scanned} tráficos`)
    }
  } catch (e) {
