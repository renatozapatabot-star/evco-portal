 ...
 *   · 3 AM Driver — número de embarque en JetBrains Mono 32px.
 */
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      >
        ...
        <Link
          href={`/embarques/${encodeURIComponent(traficoNumber)}/trace`}
          style={{
            marginLeft: 'auto',
            display: 'inline-flex',
            alignItems: 'center',
        ...
        <Link
          href={`/embarques/${encodeURIComponent(traficoNumber)}/pedimento`}
          style={{
            display: 'inline-flex',
            alignItems: 'center',
            gap: 6,
        ...
        >
          <FileText size={14} /> Ver pedimento
        </Link>
      </div>
