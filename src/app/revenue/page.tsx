...
export default async function RevenuePage() {
  ...
  const cards = [
    { label: 'Clientes Activos', value: m.active_clients || 50, sub: 'Plataforma CRUZ', color: GOLD },
    ...
    { label: 'Conversaciones AI', value: m.ai_conversations || 0, sub: 'CRUZ queries', color: 'var(--border)' },
  ]
  ...
  return (
    <div style={{ fontFamily: 'var(--font-geist-sans)', color: 'var(--border)' }} className="p-4 md:px-7 md:py-6">
      ...
      <p style={{ color: '#666', fontSize: 'var(--aguila-fs-body)', margin: '0 0 24px' }}>Visión ejecutiva del valor generado por CRUZ</p>
