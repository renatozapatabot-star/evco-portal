...
/**
 * /traficos/[id]/trace — End-to-End Trace View (V1.5 F8).
 *
 * Answers the SAT Audit standard: show the complete chain of custody for a
 * tráfico from entrada to bank reconciliation, in one chronological view.
 *
 * Role gate: admin, broker, operator, contabilidad see everything. Client
 * sees only their own tráfico (filtered by company_id in composeTrace).
 */
    ...
    <main className="aduana-dark" style={{ minHeight: '100vh', padding: '24px 20px 80px' }}>
      ...
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          >
            <ArrowLeft size={14} /> Volver al tráfico
          </Link>
          ...
          >
            <AguilaMark size={36} tone="silver" aria-label="AGUILA" />
