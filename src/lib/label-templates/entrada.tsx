/**
 * AGUILA · V1.5 F19 — Entrada 4×6" thermal label template.
 *
 ...
 * correct (thermal printers need white — the AGUILA dark cockpit ends at
    ...
    <PdfDoc>
      <Page size={[LABEL_WIDTH_PT, LABEL_HEIGHT_PT]} style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.brand}>AGUILA</Text>
        ...
        <Text style={styles.footer}>
          AGUILA · Inteligencia aduanal · Patente 3596
        </Text>
      </Page>
    </PdfDoc>
  )
