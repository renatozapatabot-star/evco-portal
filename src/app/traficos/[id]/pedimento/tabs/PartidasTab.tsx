 ...
 * Reuses Block 1's canonical PartidasTab from the tráfico detail view.
 * Partidas are managed at the tráfico level; no autosave here.
 */

import Link from 'next/link'
import { PartidasTab as TraficoPartidasTab } from '@/app/traficos/[id]/tabs/PartidasTab'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ fontSize: 11, color: ACCENT_SILVER_DIM }}>
        Las partidas se gestionan al nivel del tráfico.{' '}
        <Link
