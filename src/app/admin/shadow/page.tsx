...
export default async function AdminShadowPage() {
  ...
  const heroTiles: HeroTile[] = [
    ...
    { label: 'CRUZ acertó', value: String(stats7.systemWinsWhenDisagree), mono: true, hint: 'cuando discrepó' },
  ]
    ...
    <div style={{ padding: '8px 0', maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 'var(--aguila-fs-body)', color: TEXT_MUTED, marginTop: 6 }}>
          Estado de CRUZ vs Operadores · ventana de 7 días para titulares, 30 días para la serie
        </p>
      </div>
