    ...
    return (
      ...
      >
        ...
        <div style={{ fontSize: 13, color: TEXT_SECONDARY, textAlign: 'center', maxWidth: 420 }}>
          Sin eventos registrados. Los eventos aparecerán automáticamente cuando el tráfico avance por el sistema.
        </div>
