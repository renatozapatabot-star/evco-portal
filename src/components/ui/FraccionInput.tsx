    ...
    <div style={{ position: 'relative' }}>
      <input
        ...
        style={{
          ...
          border: `1.5px solid ${error ? '#EF4444' : 'rgba(34,211,238,0.3)'}`,
          color: '#E6EDF3',
        ...
        onFocus={e => { e.currentTarget.style.borderColor = error ? '#EF4444' : 'rgba(34,211,238,0.5)'; e.currentTarget.style.boxShadow = `0 0 12px ${error ? 'rgba(239,68,68,0.2)' : 'rgba(34,211,238,0.2)'}` }}
        onBlur={e => { e.currentTarget.style.borderColor = error ? '#EF4444' : 'rgba(34,211,238,0.3)'; e.currentTarget.style.boxShadow = 'none' }}
      />
      {error && (
