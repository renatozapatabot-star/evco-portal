      ...
      quietContent={
        <div style={{ display: 'flex', gap: 16 }}>
          <div>
            ...
            <span style={{ fontSize: 'var(--aguila-fs-compact)', color: 'var(--portal-fg-4)', marginLeft: 6 }}>esta semana</span>
          </div>
          {data.sinTrafico > 0 && (
            <div>
              ...
              <span style={{ fontSize: 'var(--aguila-fs-compact)', color: 'var(--portal-fg-4)', marginLeft: 6 }}>sin embarque</span>
            </div>
          )}
        </div>
      }
