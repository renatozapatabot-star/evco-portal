    ...
    <div className="p-6">
      ...
      <div className="card mb-4" style={{ padding: 16, display: 'flex', gap: 12, alignItems: 'center' }}>
        ...
        <button onClick={loadTrafico} disabled={loading}
          ...
          style={{ background: 'var(--amber-600)', color: 'rgba(9,9,11,0.75)', border: 'none', cursor: 'pointer', opacity: loading ? 0.6 : 1 }}>
        ...
        <>
          ...
          <div className="flex items-center gap-3">
            <button onClick={saveDraft} disabled={saving || saved}
              ...
              style={{ background: saved ? 'var(--green-bg)' : 'var(--amber-600)', color: saved ? 'var(--green-text)' : 'rgba(9,9,11,0.75)', border: 'none', cursor: 'pointer' }}>
