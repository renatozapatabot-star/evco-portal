    ...
    <div className="page-shell" style={{ maxWidth: 720 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--cruz-text-muted)', lineHeight: 1.5 }}>
          Sus documentos serán clasificados automáticamente por ADUANA
        </p>
      </div>
        ...
        <div style={{
          ...
          {uploads.map((u, i) => (
            <div key={`${u.fileName}-${i}`} style={{
              ...
              padding: '12px 20px',
              borderBottom: i < uploads.length - 1 ? '1px solid var(--cruz-border-subtle, rgba(255,255,255,0.04))' : 'none',
            }}>
              {/* Status icon */}
        ...
        <div style={{
          ...
          {blockingDocs.map(doc => (
            <div key={doc.doc_type} style={{
              display: 'flex', alignItems: 'center', gap: 12,
              padding: '12px 20px',
              borderBottom: '1px solid var(--cruz-border-subtle, rgba(255,255,255,0.04))',
            }}>
              {doc.present
