...
function StatusPill({ status }: { status: Row['status'] }) {
  const cfg = status === 'approved'
    ? { label: 'Aprobada',    bg: 'var(--portal-status-green-bg)', fg: 'var(--portal-status-green-fg)', border: 'var(--portal-status-green-ring)' }
    : status === 'draft'
    ? { label: 'Borrador',    bg: 'var(--portal-status-amber-bg)', fg: 'var(--portal-status-amber-fg)', border: 'var(--portal-status-amber-ring)' }
    : { label: 'Reemplazada', bg: 'var(--portal-status-gray-bg)',  fg: TEXT_SECONDARY,                  border: 'var(--portal-status-gray-ring)'  }
  return (
    <span style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6, flexWrap: 'wrap' }}>
                      ...
                      {o.tmec_elegibilidad ? (
                        <span style={{
                          ...
                          padding: '2px 8px', borderRadius: 999,
                          background: 'var(--portal-status-green-bg)', color: 'var(--portal-status-green-fg)',
