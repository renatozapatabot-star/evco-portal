...
/**
 * TraficoQuickActions — sticky top sub-nav for embarque detail surfaces.
 *
 * Pinned to the top of the embarque detail layout so operators can jump
...
export function TraficoQuickActions({ traficoId }: { traficoId: string }) {
  ...
  return (
    <nav
      aria-label="Acciones del embarque"
