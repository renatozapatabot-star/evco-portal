        ...
        <AreaChart data={data} margin={{ top: 4, right: 4, bottom: 0, left: -20 }}>
          <defs>
            <linearGradient id="goldGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#C4963C" stopOpacity={0.3} />
              <stop offset="100%" stopColor="#C4963C" stopOpacity={0.02} />
            </linearGradient>
          ...
          />
          <Area type="monotone" dataKey="total" stroke="#C4963C" strokeWidth={2} fill="url(#goldGrad)" />
