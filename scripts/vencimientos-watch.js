#!/usr/bin/env node
/**
 * Vencimientos watch — PM2 cron, runs daily at 09:00 America/Chicago.
 *
 * Hits /api/catalogo/vencimientos-watch which scans NOM/SEDUE/SEMARNAT
 * permits and fires Mensajería alerts at the 60- and 30-day tripwires.
 * Thin wrapper so all logic stays server-side in Next.js.
 *
 * Env:
...
const SCRIPT_NAME = 'vencimientos-watch'
const SYNC_TYPE = 'vencimientos_watch'
...
async function main() {
  ...
  const url = `${BASE}/api/catalogo/vencimientos-watch`
