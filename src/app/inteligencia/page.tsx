  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <KpiCard label="Productos clasificados" value={s.totalClassified} icon={Brain} sub="por ADUANA AI" />
      ...
      <div className="cc-card" style={{ padding: 24, borderRadius: 20 }}>
        ...
        <div style={{ fontSize: 13, color: '#94a3b8', lineHeight: 1.6 }}>
          {s.totalClassified > 0 ? (
            <>
              ADUANA ha clasificado <strong style={{ color: '#E6EDF3' }}>{s.totalClassified.toLocaleString()}</strong> productos con una confianza promedio de{' '}
