    ...
    >
      ...
      {rightAction && (
        <div style={{
          ...
          <span style={{ color: triggered ? 'rgba(255,255,255,0.04)' : rightAction.color, fontSize: 12, fontWeight: 600 }}>
      ...
      {leftAction && (
        <div style={{
          ...
          <span style={{ color: triggered ? 'rgba(255,255,255,0.04)' : leftAction.color, fontSize: 12, fontWeight: 600 }}>
