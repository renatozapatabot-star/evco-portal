export default function SolicitarLoading() {
  return (
    <div className="page-shell" style={{ maxWidth: 700, margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
        ...
        <div>
          ...
          <div className="skeleton-shimmer" style={{ width: 260, height: 14, borderRadius: 4 }} />
        </div>
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div className="skeleton-shimmer" style={{ width: '100%', height: 120, borderRadius: 12 }} />
