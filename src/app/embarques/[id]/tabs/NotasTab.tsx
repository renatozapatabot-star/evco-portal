...
import {
  MentionAutocomplete,
  type AvailableUser,
} from '@/components/trafico/MentionAutocomplete'
...
export interface NotasTabHandle {
  focusComposer: () => void
}
...
/**
 * Notes composer + history. Exposes a `focusComposer` imperative so
 * the right-rail "Agregar nota" action can hand off to it without
 * opening a modal.
 */
export const NotasTab = forwardRef<NotasTabHandle, NotasTabProps>(function NotasTab(
  { traficoId, notes, availableUsers },
  ref,
) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div>
        ...
        <textarea
          ...
          placeholder="Escribe aquí. Usa @ para mencionar a alguien."
          rows={3}
          maxLength={4000}
          style={{
            width: '100%',
